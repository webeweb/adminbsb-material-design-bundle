...
/**
 * Overlined typography Twig extension test.
 *
 * @author webeweb <https://github.com/webeweb/>
 * @package WBW\Bundle\AdminBSBBundle\Tests\Twig\Extension\Typography
 * @final
 */
final class OverlinedTypographyTwigExtensionTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetFunctions() {
        ...
        $obj = new OverlinedTypographyTwigExtension();
        ...
        $this->assertEquals("adminBSBOverline", $res[0]->getName());
        $this->assertEquals([$obj, "adminBSBOverlineFunction"], $res[0]->getCallable());
