...
final class HeadingTypographyTwigExtensionTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetFunctions() {
        ...
        $this->assertEquals("adminBSBHeading6", $res[5]->getName());
