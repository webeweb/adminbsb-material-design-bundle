...
final class CheckboxTwigExtensionTest extends PHPUnit_Framework_TestCase {
    ...
    public function testGetFunctions() {
        ...
        $this->assertEquals("adminBSBBasicCheckbox", $res[0]->getName());
        $this->assertEquals([$obj, "adminBSBBasicCheckboxFunction"], $res[0]->getCallable());
        $this->assertEquals(["html"], $res[0]->getSafe(new Twig_Node()));

        $this->assertInstanceOf(Twig_SimpleFunction::class, $res[1]);
        $this->assertEquals("adminBSBMaterialDesignCheckbox", $res[1]->getName());
        $this->assertEquals([$obj, "adminBSBMaterialDesignCheckboxFunction"], $res[1]->getCallable());
        $this->assertEquals(["html"], $res[1]->getSafe(new Twig_Node()));
    }

    /**
     * Tests the adminBSBBasicCheckboxFunction() method.
     *
     * @return void
    ...
    public function testAdminBSBBasicCheckbox() {
        ...
        $this->assertEquals($res0, $obj->adminBSBBasicCheckboxFunction($arg0));
    }

    /**
     * Tests the adminBSBMaterialDesignCheckboxFunction() method.
     *
     * @return void
     * @depends testGetFunctions
     */
    public function testAdminBSBMaterialDesignCheckboxCheckbox() {
        ...
        $this->assertEquals($res0, $obj->adminBSBMaterialDesignCheckboxFunction($arg0));

        $arg1 = ["content" => "content"];
        $res1 = '<input class="chk-col-red" type="checkbox"><label for="">content</label>';
        $this->assertEquals($res1, $obj->adminBSBMaterialDesignCheckboxFunction($arg1));

        $arg2 = ["name" => "name"];
        $res2 = '<input class="chk-col-red" name="name" type="checkbox"><label for=""></label>';
        $this->assertEquals($res2, $obj->adminBSBMaterialDesignCheckboxFunction($arg2));

        $arg3 = ["id" => "id"];
        $res3 = '<input class="chk-col-red" type="checkbox" id="id"><label for="id"></label>';
        $this->assertEquals($res3, $obj->adminBSBMaterialDesignCheckboxFunction($arg3));

        $arg4 = ["checked" => true];
        $res4 = '<input class="chk-col-red" type="checkbox" checked="checked"><label for=""></label>';
        $this->assertEquals($res4, $obj->adminBSBMaterialDesignCheckboxFunction($arg4));

        $arg5 = ["disabled" => true];
        $res5 = '<input class="chk-col-red" type="checkbox" disabled="disabled"><label for=""></label>';
        $this->assertEquals($res5, $obj->adminBSBMaterialDesignCheckboxFunction($arg5));

        $arg6 = ["filledIn" => true];
        $res6 = '<input class="filled-in chk-col-red" type="checkbox"><label for=""></label>';
        $this->assertEquals($res6, $obj->adminBSBMaterialDesignCheckboxFunction($arg6));

        $arg7 = ["class" => "class"];
        $res7 = '<input class="class chk-col-red" type="checkbox"><label for=""></label>';
        $this->assertEquals($res7, $obj->adminBSBMaterialDesignCheckboxFunction($arg7));

        $arg8 = ["color" => "black"];
        $res8 = '<input class="chk-col-black" type="checkbox"><label for=""></label>';
        $this->assertEquals($res8, $obj->adminBSBMaterialDesignCheckboxFunction($arg8));
        ...
        $this->assertEquals($res9, $obj->adminBSBMaterialDesignCheckboxFunction($arg9));
    }
