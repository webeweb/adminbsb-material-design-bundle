...
use WBW\Bundle\AdminBSBMaterialDesignBundle\Navigation\Node\Action\NavigationNodeNewUserAction;
...
final class NavigationNodeNewUserActionTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$this->assertEquals("person_add", $obj->getIcon(), "The method getIcon() does not return the expecetd value");
