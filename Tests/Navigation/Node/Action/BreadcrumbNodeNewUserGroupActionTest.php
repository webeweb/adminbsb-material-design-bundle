...
use WBW\Bundle\AdminBSBMaterialDesignBundle\Navigation\Node\Action\BreadcrumbNodeNewUserGroupAction;
...
final class BreadcrumbNodeNewUserGroupActionTest extends PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		...
		$this->assertEquals("group_add", $obj->getIcon(), "The method getIcon() does not return the expecetd value");
